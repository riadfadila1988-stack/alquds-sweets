...
import { View, Text, TextInput, StyleSheet, Button, TouchableOpacity, I18nManager, KeyboardAvoidingView, Platform } from 'react-native';
    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      ...
      >
        <DraggableFlatList
          ...
          renderItem={({ item: task, index: taskIndex, drag, isActive }: RenderItemParams<Partial<ITask>>) => {
            return (
